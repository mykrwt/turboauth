...
public class ConfigManager {
    ...
    private void setDefaults() {
        ...
        config.addDefault("settings.ip-ban-duration", "3600");
    ...
    public Location getAuthSpawn() {
        World world = plugin.getServer().getWorld(config.getString(AUTH_SPAWN));
        if (world != null) {
            return new Location(
                world,
    ...
    public Location getFallbackSpawn() {
        World world = plugin.getServer().getWorld(config.getString(FALLBACK_SPAWN));
        if (world != null) {
            return new Location(
                world,
